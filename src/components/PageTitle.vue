        ...
        <el-row>
            ...
            <el-col >
                <el-tabs v-model="activeName" @tab-click="handleClick" >
                    <el-tab-pane label="章节" name="first" ><ChapterDetail></ChapterDetail></el-tab-pane>
                    <el-tab-pane label="课程分组" name="third"><CourseGroup></CourseGroup></el-tab-pane>
                    ...
                    <el-tab-pane label="测试" name="seven"><StudyDiscuss></StudyDiscuss></el-tab-pane>
...
export default {
    name:"PageTitle",
    components: {StudyDiscuss, GroupChat, CourseGroup, DataBank, StudentTask, DiscussDetail, ChapterDetail},
    data() {
        return {
            activeName: 'first',
            //active:0
